...
export default function AboutPage() {
  return (
    <div className="page blog-page about-page">
      ...
      <main className="about-main">
        <article className="about-article">
          ...
          <section className="about-bio" aria-labelledby="bio-title">
            ...
            <p>
              예비창업자와 초기 창업자가 지원사업을 준비하며 반복해서 마주치는 질문을 정리합니다. 공고를 어디서 찾아야 하는지, 평가자가
              무엇을 확인하는지, 아이디어를 어떤 문장으로 설명해야 하는지를 실제 작성 순서에 맞춰 풀어냅니다.
            </p>
            <p>
          ...
          <section className="about-company-intro" aria-labelledby="company-title">
            ...
            <p>
              독스헌트는 주식회사 사페레아우데가 운영하는 사업계획서 AI입니다. 창업자와 실무자가 반복적인 문서 작업보다 아이디어 검증과
              실행에 집중할 수 있도록 지원사업 공고 탐색과 사업계획서 작성을 돕습니다.
            </p>
          </section>
