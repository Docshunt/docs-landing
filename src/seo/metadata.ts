...
export const DEFAULT_TITLE = "모든 지원사업, 사업계획서를 작성하는 AI | 쓰면 쓸수록 더 잘 써주는 독스헌트, 지금 바로 만나보세요";
...
export const BLOG_LIST_TITLE = "사업계획서 AI, 정부지원사업에 어떻게 활용할까요? | 독스헌트 실전 가이드";
export const BLOG_LIST_DESCRIPTION =
  "정부지원사업 공고를 읽는 법부터 사업계획서 문장·평가 기준·AI 활용까지, 예비·초기창업자가 신청 전에 확인할 실전 기준을 독스헌트 블로그에서 살펴보세요. 공고가 바뀌어도 적용할 수 있는 준비 방법을 안내합니다.";
...
export const PRICING_TITLE = "독스헌트 요금제 비교 | 지원사업 사업계획서 작성 AI 기능·플랜·이용 조건 안내";
export const PRICING_DESCRIPTION =
  "지원사업 공고 분석부터 사업계획서 초안 작성까지, 독스헌트 요금제별 기능과 이용 조건을 비교해보세요. 준비 단계에 맞는 플랜, 작성 지원 범위와 크레딧 사용 방식을 한눈에 확인할 수 있습니다.";
...
export const SAMPLE_TITLE = "사업계획서 예시·샘플 | 정부지원사업 문항별 AI 작성 과정과 활용 기준 안내";
export const SAMPLE_DESCRIPTION =
  "사업계획서 예시와 샘플을 보며 지원사업 문항에 어떤 근거를 넣어야 하는지 확인하세요. 독스헌트 AI가 아이디어를 사업계획서 초안으로 정리하는 과정, 문항별 작성 포인트와 활용 기준을 소개합니다.";
