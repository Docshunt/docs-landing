...
export const post83 = {
  ...
  description:
    "2026년 모두의 창업 1기 FAQ에서는 한 줄 아이디어의 공개·비공개를 신청자가 선택할 수 있었습니다. 공개 범위와 선정 이후 동의 절차, 공개 전 확인할 사항을 정리했습니다.",
  seo: {
  ...
  verification: {
    date: "2026.08.13",
    note: "2026년 모두의 창업 1기 통합 모집공고와 일반·기술트랙 FAQ를 확인했습니다. 1기 FAQ는 도전자가 한 줄 아이디어의 공개·비공개를 선택하고, 한 줄 외 세부 내용은 비공개라고 안내합니다. 선정 이후 아이디어 발전 과정 공개는 도전자 동의를 전제로 하며 핵심·원천기술은 제외합니다. 이 내용은 1기 기준으로, 다음 모집에서는 새 공고와 FAQ를 다시 확인해야 합니다.",
    sources: [
  ...
  paragraphs: [
    ...
    "공개 대상으로 선택할 수 있었던 것은 한 줄 아이디어였고, 신청서에 적은 세부 내용은 비공개라고 FAQ가 안내했습니다.",
    "선정 이후 아이디어 발전 과정을 플랫폼에 소개하는 절차는 별도 동의를 전제로 했으며, 핵심·원천기술은 공개 대상에서 제외한다고 안내했습니다.",
    "공개를 선택한다면 고객 문제와 가치만 간결하게 설명하고, 구현 방식·미공개 데이터·권리화 전 핵심 기술까지 한 줄에 넣지 않는 편이 안전합니다. 다음 모집에서는 새 공고와 FAQ를 최종 기준으로 확인해야 합니다.",
  ],
  ...
  <p>따라서 신청 화면의 한 줄 공개 선택과 선정 뒤 홍보·성장 과정 공개 동의는 같은 결정이 아닙니다. 나중에 별도 동의 화면이나 안내를 받으면 공개 범위, 사용 기간과 매체를 다시 확인해야 합니다.</p>
  ...
  <p><a href="${FIRST_COHORT_PDF_URL}" target="_blank" rel="noopener noreferrer">1기 통합 모집공고 PDF</a>는 공개된 아이디어와 특허·디자인 출원 시점에 관한 주의사항도 안내합니다. 공고에는 공개 후 특허·실용신안 12개월, 디자인 6개월과 관련된 안내가 있지만, 실제 권리 확보 가능성은 공개 내용과 출원 상황에 따라 달라질 수 있습니다. 중요한 기술이라면 공개 전에 전문가에게 확인하는 편이 안전합니다.</p>
  ...
  <p><strong class="dh-emphasis">한 줄 아이디어의 공개 여부는 선택할 수 있었지만, 제출 전에 선택값과 공개 문장을 직접 확인하는 과정은 신청자의 몫입니다.</strong></p>
