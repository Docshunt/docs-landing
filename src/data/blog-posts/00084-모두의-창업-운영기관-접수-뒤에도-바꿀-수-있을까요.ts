...
export const post84 = {
  ...
  description:
    "2026년 모두의 창업 1기에서는 접수 기간 중 운영기관을 바꿀 수 있었지만 마감 뒤에는 변경할 수 없었습니다. 지역·전문분야·멘토링 참여 가능성을 기준으로 고르는 법을 정리했습니다.",
  seo: {
  ...
  verification: {
    date: "2026.08.13",
    note: "2026년 모두의 창업 1기 통합 모집공고와 일반·기술트랙 FAQ를 확인했습니다. 1기에서는 신청할 때 운영기관 1곳을 선택하고, 접수 기간 중에는 아이디어와 운영기관을 변경할 수 있었지만 마감 이후에는 변경할 수 없었습니다. 다른 지역 기관도 선택할 수 있으나 대면 프로그램 참여 가능성을 고려하도록 안내했습니다. 다음 모집에서는 새 공고와 FAQ를 다시 확인해야 합니다.",
    sources: [
  ...
  paragraphs: [
    ...
    "거주지와 다른 지역의 기관도 선택할 수 있었지만, 선택한 지역에서 제공하는 대면 프로그램에 참여할 수 있어야 했습니다. 1기 FAQ는 책임멘토와 1대1 대면 멘토링을 4회 안팎으로 안내했습니다.",
  ...
  <p>따라서 잘못 선택했다면 마감 전 수정·재제출 절차를 확인해야 합니다. “일단 아무 기관이나 고르고 나중에 옮기자”는 방식은 마감 뒤에 막힐 수 있습니다.</p>
  ...
  <p>특히 책임멘토와 1대1 대면 멘토링이 4회 안팎으로 예정돼 있다는 안내가 있었습니다. 직장인이나 군 장병처럼 대면 참석이 어려운 경우 운영기관과 합의해 비대면 지원이 가능하다고 설명했지만, 모든 일정을 자동으로 비대면 전환해준다는 뜻은 아닙니다.</p>
  <ul>
  ...
  <p><strong class="dh-emphasis">운영기관은 마감 전에는 고칠 수 있었지만, 마감 뒤에는 바꿀 수 없었습니다. 이름보다 실제로 참여하고 도움받을 수 있는 곳인지 먼저 보세요.</strong></p>
